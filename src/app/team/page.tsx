  ...
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-16">
      ...
      <p className="mt-6 max-w-[70ch] text-base leading-relaxed text-charcoal">
        ...
        below, working across the Chamber&rsquo;s three core areas &mdash;
        criminal, constitutional and writ, and civil litigation &mdash; under
        the direction of the Proprietor.
      </p>
        ...
        {team.map((member) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              {member.courts && (
                <ul className="mt-3 space-y-1 border-t border-line pt-3 text-xs text-charcoal/70">
